...
// final Terms of Use in place; do not move or rename the route.
export const metadata: Metadata = {
  title: "CraftiMe Terms of Use",
  robots: { index: false },
};
  ...
  return (
    <section className="mx-auto max-w-prose px-5 py-16 sm:px-8 sm:py-24">
      <h1 className="font-display text-3xl font-semibold leading-[1.1] tracking-tight text-fg sm:text-4xl">
        CraftiMe Terms of Use
      </h1>
      <p className="mt-6 font-sans text-base leading-relaxed text-fg/90 sm:text-lg">
        CraftiMe is in private testing. The Terms of Use for the CraftiMe beta
        are being finalized and will be published at this address before the
        beta opens.
      </p>
