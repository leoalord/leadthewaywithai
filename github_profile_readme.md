...
### Core Tech Stack
* **Languages & Web:** Python (primary), SQL, TypeScript, JavaScript, Next.js, React, Tailwind CSS
* **AI & Agent Ecosystem:** LangChain, Hugging Face, Anthropic, OpenAI, Fireworks.ai, Mistral, PyTorch, Google AGY
* **Infrastructure & Tools:** AWS (primary), Azure, GCP, PostgreSQL, Docker, Cursor, Claude Code
